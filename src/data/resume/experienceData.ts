export const staticExperienceData = [
  ...
  },
  {
    ...
    start_date: "May 2025",
    end_date: null,
    description: "Independent consulting and advisory work supporting regulated public sector and enterprise customers with adoption readiness, operating-model alignment, and technical value realization.\n• Deliver executive-ready assessments and roadmaps that clarify current state, target state, risk, and prioritized remediation.\n• Create reusable enablement assets including workshops, evaluation checklists, and implementation playbooks.\n• Support practical advisory work across GRC, AI governance, cybersecurity compliance, ServiceNow IRM, and technology operating models.",
    display_order: 1
  },
  {
    id: "2",
