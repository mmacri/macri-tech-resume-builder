...
/**
 * Add a new experience item to the database
 */
export const addExperienceItem = async (item: any, options: UpdateOptions = { updateIndex: false, updateResume: true }) => {
  const { updateIndex = false, updateResume = true } = options;
  
  // Log the operation with options
 ...
 */
export const updateExperienceItem = async (item: any, options: UpdateOptions = { updateIndex: false, updateResume: true }) => {
  const { updateIndex = false, updateResume = true } = options;
 ...
 */
export const deleteExperienceItem = async (id: string, options: UpdateOptions = { updateIndex: false, updateResume: true }) => {
  const { updateIndex = false, updateResume = true } = options;
...
/**
 * Reorder experience items by swapping their display_order values
 */
export const reorderExperienceItems = async (id1: string, id2: string, options: UpdateOptions = { updateIndex: false, updateResume: true }) => {
  const { updateIndex = false, updateResume = true } = options;
