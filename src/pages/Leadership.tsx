    ...
    <section className="bg-white py-14" aria-labelledby="scale-cse-heading">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <article>
          ...
          <p className="mb-5 max-w-4xl text-base leading-7 text-gray-700">That model also requires visibility. Customer assignment alone does not show where technical capacity is actually being spent. Engagement, workload, renewal timing, customer signals, and pooled work need to be visible enough for leaders to understand where technical expertise is being used and where it may be needed next.</p>
