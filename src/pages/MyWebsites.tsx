  ...
  return (
    <article id={project.id} className="flex h-full scroll-mt-24 flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        {project.id === 'gitlab-health' && <p className="mb-4 rounded-lg border border-orange-200 bg-orange-50 p-3 text-sm font-semibold leading-6 text-slate-900">Personal prototype / portfolio project — not an official GitLab product.</p>}
