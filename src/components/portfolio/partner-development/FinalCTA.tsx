    ...
    <section className="py-16 md:py-20 bg-gradient-to-br from-macri-primary/5 to-accent/10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="font-saira text-3xl md:text-4xl font-bold text-macri-primary mb-6">
          Let's Build the Next Great Partnership
        </h2>
        
        <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
          If you're looking for a leader who understands how to design and grow partner ecosystems that create measurable value, let's connect.
        </p>
