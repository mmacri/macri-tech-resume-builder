  ...
  const renderFormattedIntro = () => {
    return (
      <div className="about-intro text-lg">
        <p className="mb-6">
          Driving Solutions and Unlocking Business Value with a proven track record of building <span className="font-semibold italic">high-performing Solution Engineering</span> and Customer Success teams in the enterprise cloud ecosystem.
        </p>
