...
const HomeContent: React.FC = () => {
  ...
  return (
    <div className="resume-container">
      <AboutSection items={[]} />
      <hr className="m-0" />
      <ExperienceSection items={staticExperienceData} />
      <hr className="m-0" />
      <EducationSection items={staticEducationData} />
      <hr className="m-0" />
      <SkillsSection items={staticSkillsData} />
      <hr className="m-0" />
      <InterestsSection items={staticInterestsData} />
      <hr className="m-0" />
      <AwardsSection items={staticAwardsData} />
    </div>
  );
};
